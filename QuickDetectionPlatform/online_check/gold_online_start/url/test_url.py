...
@Software: PyCharm
"""
api = 'http://test-client.ehomepoct.com/'
...
blood_order_palce = 'https://check-gateway.ehomepoct.com/blood-cell-analysis/order/palce'

blood_test = 'http://check-gateway.ehomepoct.com/blood-cell-analysis/check/start'
