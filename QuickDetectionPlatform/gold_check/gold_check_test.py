...
from utils import get_clinic_info_test, login, Log, mysql_utils_test, enum_mold
from gold_check.data import test_data
from gold_check.url import test_url
...
class GoldCheckTest:
    ...
    def start_check(self):
        ...
        test_data.check_data['sno'] = self.gold_sno
        res = requests.post(url=test_url.start_check, data=test_data.check_data, files=self.test_name,
    ...
    def create_order(self):
        ...
        test_data.create_order['clinicId'] = self.clinic_id
        test_data.create_order['patientId'] = self.patientId
    ...
    def call_back(self):
        ...
        log.info('支付回调接口请求参数为：' + str(test_data.check_data))
...
if __name__ == '__main__':
    Blood_check = GoldCheckTest(13622223661, 0)
